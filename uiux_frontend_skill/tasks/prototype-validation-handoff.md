...
Use this when preparing prototypes for testing, developer handoff, QA, or release validation.
...
2. Define validation question.
   ...
   - Verify: each test has one primary question.
3. Prepare scenarios.
   - Give users a goal and context, not step-by-step instructions.
   - Verify: scenario reflects realistic intent.
...
6. QA.
   ...
   - Verify: test states, breakpoints, data extremes, keyboard, screen reader, and reduced motion.
