# Run Engineering Organization Review

Use this for org health, team topology, Conway mapping, manager effectiveness, capacity, succession, or reorganization review.

1. Map current organization.
   - Verify: teams, missions, managers, spans, systems owned, and dependencies are visible.
2. Map architecture and delivery flow.
