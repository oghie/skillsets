...
CHECKS = {
    ...
    "data_model_notation": ["relational", "key-value", "column-family", "array", "matrix", "hierarchical", "geospatial", "metamodel"],
    ...
    "database_problem_prevention": ["deadlock", "blocking", "connection exhaustion", "full table scan", "i/o wait", "slow query", "bad query"],
