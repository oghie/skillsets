...
## Expected Workflow
1. Gather facts: platform level, language/runtime, scheduler, clock source, task/rank/thread topology, shared resources, communication links, and timing constraints.
